                    ...
                    <div class="col-lg-12">
                        <div class="shipping-method-area mt-70">
                            ...
                            <div class="custom-control custom-radio mb-30">
                                ...
                                <label class="custom-control-label d-flex align-items-center justify-content-between" for="customRadio1"><span>Cash On Delivery</span><span>Rs.37,999</span></label>
                            </div>

                            <div class="custom-control custom-radio mb-30">
                                <input type="radio" id="customRadio2" name="customRadio" class="custom-control-input">
                                <label class="custom-control-label d-flex align-items-center justify-content-between" for="customRadio2"><span>Debit Card(5% off on Select banks)</span><span>Rs.37,250*</span></label>
                            </div>

                            <div class="custom-control custom-radio">
                                <input type="radio" id="customRadio3" name="customRadio" class="custom-control-input">
                                <label class="custom-control-label d-flex align-items-center justify-content-between" for="customRadio3"><span>Credit Card(10% off on Select banks)</span><span>Rs.36,550*</span></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
