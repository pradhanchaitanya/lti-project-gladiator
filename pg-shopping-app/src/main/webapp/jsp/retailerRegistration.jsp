...
<body>
   ...
   -->
	...
	<div id="outer">
		...
		<h1 >Register</h1>
		<form name="myForm" action="registerRetailer.do" method="post">
			<div class="extra">
			...
			<div>
				...
				<br>
				<p><i><b>Already a Retailer?</b></i> <a href="loginRetailer.do" style="float:right;">Click Here to Login in</a></p>
			</div>
