...
<body>
   ...
   <script>
	...
	<div id="outer">
		...
		<form name="myForm" action="registerRetailer.do" method="post" modelAttribute="userDTO">
			<div class="extra">
			...
			<p><i><b>Already a User?</b></i> <a href="loginRetailer.do" style="float:right;">Click Here to Login</a></p>
		</form>
	</div>
